      ...
      async authorize(credentials) {
        ...
        try {
          ...
          if (credentials.portalType) {
            ...
            const requiredRole = portalRoleMap[credentials.portalType];
            if (requiredRole && user.role !== requiredRole) {
              throw new Error(
                `Invalid credentials for ${credentials.portalType} portal. Your role is ${user.role}, but this portal is for ${requiredRole}s only.`
              );
            }
          }
